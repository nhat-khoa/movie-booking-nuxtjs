    ...
    <div id="footer">
            ...
            <div class="col-md-8 col-sm-12">
              <div class="row">
                ...
                <div class="col-md-6 connect-us">
                  ...
                  <a
                    href="https://www.facebook.com/touchcinema/"
                    target="_blank"
                  >
                  ...
                  <a
                    href="https://itunes.apple.com/vn/app/touch-cinema/id1329661214?l=vi"
                    target="_blank"
                  >
                    <img src="/images/icons/app-ios.png" alt="Appstore" />
                  </a>
                  <a
                    href="https://play.google.com/store/apps/details?id=com.touchcinema.cinema"
                    target="_blank"
                  >
                    <img
                      src="/images/icons/app-android.png"
                      alt="Google Play"
                    />
                  </a>
                  <a href="https://m.touchcinema.com/phim" class="mobile_link"
                    >Phiên bản Mobile</a
                  >
                </div>
              </div>
            ...
            <div class="col-md-4 co-sm-12">
              ...
              <div class="row text-detail">
                <div class="col-md-6 col-sm-6">
                  ...
                  <a href="chinh-sach-bao-mat-thong-tin-ca-nhan-khach-hang.html"
                ...
                <div class="col-md-6 col-sm-6">
                  ...
                  <a
                    href="khuyen-mai/huong-dan-dat-ve-online-tai-rap-touch-cinema.html"
                    >Hướng dẫn đặt vé online</a
                  >
                ...
                <div class="col-md-6 col-sm-6">
                  ...
                  >
                    <img
                      ...
                      src="/images/icons/dathongbao.png"
      ...
      <div class="footer-wrap">
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              <p class="copyright">Copy2025 Touch Cinema</p>
            </div>
          </div>
        </div>
      </div>
